...
if __name__ == '__main__':
    ...
    # 모델 생성
    model = LeNet(_input_channel=3, num_class=10)
    model.to(device)
    ...
    # 테스트 할 모델 체크포인트 경로
    # 빈 칸 채우기
    test_checkpoint = 'checkpoint/5_checkpoint.pth'
    ...
    # 데이터셋 로드
    # 빈 칸 채우기
    test_data = dsets.CIFAR10(root="/" , train=False, transform=transform_test, download=True)
